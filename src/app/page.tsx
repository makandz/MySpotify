    ...
    <>
      <div className="text-center font-display mt-14">
        <h1 className="text-7xl font-extrabold">
          Your music <span className="text-green-900">speaks</span>.
        </h1>
      </div>

      <div className="mx-auto max-w-2xl w-100 text-center mt-3">
        <h2 className="text-xl">
          See which artists and tracks you&apos;ve listened to the most within
          the past month, six month, or even all-time in a single place.
        </h2>
      </div>
